...
var linkPro: LinkGameModel = LinkGameModel()
...
//        APIService.shared.getJsonproMain(){response,error in
//            if let response = response{
//                linkPro = response
//                if let link = linkPro.link {
//                    if link.count > 1{
//                        let storyboard = UIStoryboard(name: "MainPro", bundle: nil)
//                        let vc = storyboard.instantiateViewController(withIdentifier: "LoadViewGameVC") as! LoadViewGameVC
//                        vc.linkHD = link
//                        vc.sizeWeb = linkPro.sizeWeb ?? 130
//                        vc.statusBarHeightServer = linkPro.statusBarHeightServer ?? 35
