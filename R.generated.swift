...
struct _R {
  ...
  struct nib {
    ...
    /// Nib `Template1CLVCell`.
    var template1CLVCell: RswiftResources.NibReferenceReuseIdentifier<Template1CLVCell, Template1CLVCell> { .init(name: "Template1CLVCell", bundle: bundle, identifier: "Template1CLVCell") }
    ...
    func validate() throws {
      ...
      if UIKit.UIImage(named: "count_comment", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'count_comment' is used in nib 'Template1CLVCell', but couldn't be loaded.") }
      if UIKit.UIImage(named: "count_view", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'count_view' is used in nib 'Template1CLVCell', but couldn't be loaded.") }
      if UIKit.UIImage(named: "logo", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'logo' is used in nib 'Template1CLVCell', but couldn't be loaded.") }
      if UIKit.UIImage(named: "template1", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'template1' is used in nib 'Template1CLVCell', but couldn't be loaded.") }
  ...
  struct storyboard {
    ...
    var mainPro: mainPro { .init(bundle: bundle) }

    func launchScreen(bundle: Foundation.Bundle) -> launchScreen {
      .init(bundle: bundle)
    }
    func mainPro(bundle: Foundation.Bundle) -> mainPro {
      .init(bundle: bundle)
    }
    func validate() throws {
      try self.launchScreen.validate()
      try self.mainPro.validate()
    }
    ...
    /// Storyboard `MainPro`.
    struct mainPro: RswiftResources.StoryboardReference {
      let bundle: Foundation.Bundle

      let name = "MainPro"

      var loadViewGameVC: RswiftResources.StoryboardViewControllerIdentifier<LoadViewGameVC> { .init(identifier: "LoadViewGameVC", storyboard: name, bundle: bundle) }

      func validate() throws {
        if loadViewGameVC() == nil { throw RswiftResources.ValidationError("[R.swift] ViewController with identifier 'loadViewGameVC' could not be loaded from storyboard 'MainPro' as 'LoadViewGameVC'.") }
      }
    }
  }
}